...
const Navbar = ({setShowLogin}) => {
    ...
    // state for choosen menu item
    const [menu, setMenu] = useState("home"); //iitiallized with home
  ...
  return (
    <div className='navbar'>
        ...
        <ul className=' navbar-menu'>
            ...
            <a href='#footer' onClick={()=>setMenu("contct-us")} className={ menu==="contct-us"?"active":"" } >contact us</a>
        </ul>
